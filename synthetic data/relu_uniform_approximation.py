# -*- coding: utf-8 -*-
"""ReLU uniform approximation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_qxBoJZ0LkVuy8ZDL8Xzh_BCV4fcdnW3
"""
...
def get_error(Worig,borig,W_hat,b_hat):
    ...
    X = grid[np.random.choice(grid.shape[0], size=10000, replace=False)]
...
def fit_relu(sample_sizes,Worig,borig,noise_variance,biases,d=2,num_iterations=100):
    ...
    for m in sample_sizes:
        ...
        for itr in range(num_iterations):
            ...
            # Xu = grid[np.random.choice(grid.shape[0], size=m, replace=False)]
...
sample_sizes = [10,20,25,40,60,80,100,120]
...
path = "drive/MyDrive/ICLR_2023/relu_uniform/aistats_var_0.05/"
os.mkdir(path)
# !cp error_l_med.npy /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/
# !cp error_l_mean.npy /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/
# !cp error_u_med.npy /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/
# !cp error_u_mean.npy /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/

!cp orig.png /content/drive/MyDrive/ICLR_2023/relu_uniform/aistats_var_0.05/
# !cp Error_mean.png /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/
# !cp Error_median.png /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/
# !cp sample_sizes.npy /content/drive/MyDrive/ICLR_2023/relu_gaussian/relu_uniform/

plt.rcParams.update(plt.rcParamsDefault)
style = 'seaborn-dark-palette'
latex_plot_error(sample_sizes[3:],error_l_mean[3:],error_u_mean[3:],Worig,borig,style,'mean_plot')
path = "drive/MyDrive/ICLR_2023/relu_uniform/"

# os.mkdir(path)
!cp mean_plot.tex /content/drive/MyDrive/ICLR_2023/relu_uniform/aistats_var_0.05/
